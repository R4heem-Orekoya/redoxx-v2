...
import SenddImage from "../../../public/sendd.png";
	...
	return (
		<div className="space-y-12">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				<Link
					href="https://sendd.app"
					target="_blank"
					rel="noopener noreferrer"
					className="space-y-4 group"
					aria-label="Sendd"
				>
					<div className="group bg-secondary border border-border/40 aspect-16/10 rounded-lg p-1 flex flex-col gap-2">
						<div className="relative border border-border/40 rounded-sm overflow-hidden flex-1">
							<Image
								src={SenddImage}
								alt="sendd og image"
								fill
								className="object-cover origin-left transition-transform duration-300 group-hover:scale-105"
							/>
						</div>
					</div>
					...
					<div className="flex items-start justify-between px-1 pb-1">
						<div className="space-y-1">
							...
							<p className="text-xs text-muted-foreground leading-snug">
								Workspace to run your freelance business
							</p>
						</div>
						<HugeiconsIcon
